...
DIABETES_DATASET = """num_pregnant,plasma_glucose,diastolic_pressure,skin_thickness,insulin,BMI,diabetes_pedigree_function,age,targets
...
class diabetes_dataset():
    def __init__(self):
        self.df = pd.read_csv(StringIO(DIABETES_DATASET))
